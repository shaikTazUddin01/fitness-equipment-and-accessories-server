...
router.delete("/:id", (0, auth_1.default)(admin_constant_1.ROLE.Admin, admin_constant_1.ROLE.SubAdmin), category_controller_1.CategoryController.deleteCategory);
router.put("/:id", (0, auth_1.default)(admin_constant_1.ROLE.Admin, admin_constant_1.ROLE.SubAdmin), category_controller_1.CategoryController.updateCategory);
