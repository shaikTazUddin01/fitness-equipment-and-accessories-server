...
router.get('/',auth(ADMIN_ROLE.admin,ADMIN_ROLE.subAdmin),productController.getProducts)
router.get('/:id',auth(ADMIN_ROLE.admin,ADMIN_ROLE.subAdmin),productController.getProductById)
